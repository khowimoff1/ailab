...
const Barriers = () => {
	...
	const items = [
		...
		},
		{
			id: 2,
			question: 'Это сложно',
			answer: 'Дадим готовую методологию + внедряемые инструменты',
		},
		{
			id: 3,
			question: 'У нас нет специалистов, которые смогут внедрить это',
			answer: 'Мы даем готовые методики и шаблоны — не нужно нанимать новых людей.',
		},
		{
			id: 4,
			question: 'Наши процессы слишком сложные, AI не поможет',
			answer: 'Сложные процессы — идеальная зона для AI: мы покажем примеры оптимизации в ритейле, логистике, финансах',
		},
		{
			id: 5,
